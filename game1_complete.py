...
def remove_punct(text):
    ...
    'goSouTh'
    """
    punctless= "" #this holds string when punct removed

    for char in text:
        if char not in string.punctuation:
            punctless += char
            return punctless
# This remove the punct and returns a punctless string
...
def remove_spaces(text):
    ...
    ''
    """
    text = text.strip() #simplest way of stripping down leading/trailing spaces
    return text 
...
def display_room(room):
    ...
    print blankline, print room name, blankline, desc, blankline """
    print()
    print(str.upper(room["name"]))
    print()
...
def menu(exits):
    ...
    # Repeat until the player enters a valid  navigational choice
    while True:
